            ...
            <div class="col-md-3 left_col">
               <div class="left_col scroll-view">
                  <div class="navbar nav_title" style="border: 0;">
                     <a href="index.html" class="site_title"><i class="fa fa-paw"></i> <span><b>School App</b></span></a>
                  </div>
                     ...
                     <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                           <li>
                            ...
                            <li>
                              <a><i class="fa fa-chalkboard-teacher"></i> <b>Teachers</b> <span class="fa fa-chevron-down"></span></a>
                              <ul class="nav child_menu">
                                 <li><a href="/teachers/"><b>View All</b></a></li>
                                 <li><a href="/teachers/create"><b>Create</b></a></li>
                              </ul>
                           </li>
                           <li>
                              <a><i class="fa fa-"></i> Classes <span class="fa fa-chevron-down"></span></a>
                              <ul class="nav child_menu">
                                 <li><a href="/Classes/">Class View</a></li>
                                 <li><a href="/Classes/create">Class Create</a></li>
                              </ul>
                           </li>
                           <li>
                              <a><i class="fa fa-"></i> Country <span class="fa fa-chevron-down"></span></a>
                              <ul class="nav child_menu">
                                 <li><a href="/Country/country">Country</a></li>
                                 
                                 <li><a href="/Country/city">City</a></li>
                                 <li><a href="/Country/test">test</a></li>
                              </ul>
                           </li>
                        </ul>
                     </div>
                  ...
                  <nav class="nav navbar-nav">
                     <ul class=" navbar-right">
                        <li class="nav-item dropdown open" style="padding-left: 15px;">
                           ...
                           <img src="/public/assets/images/img.jpg" alt="">Asad Baloch
                           </a>
